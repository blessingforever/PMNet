...
class InferenceCore:
    ...
    def do_pass_PMNet_indep_sample(self, key_k, key_v, key_k_emb, idx, end_idx, name):
            ...
            if ti != end:                    
                ...
                if self.include_last or is_proto_frame:
                    ...
                    for n in range(self.k):
                        ...
                        # update proto when object occurs
    ...
    def interact_PMNet(self, mask, frame_idx, end_idx, name):
        ...
        # Propagate
        self.do_pass_PMNet_indep_sample(key_k, key_v, key_k_emb, frame_idx, end_idx, name)
