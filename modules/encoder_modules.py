...
from modules import mod_resnet
...
# Multiple objects version, used in other times
class ValueEncoder_R50(nn.Module):
    def __init__(self):
        super().__init__()
...
class KeyEncoder(nn.Module):
    def __init__(self):
        ...
        state_dict=torch.load(r'/ghome/linfc/my_VOS_new/pretrained_resnet/resnet50-19c8e357.pth')
...
class KeyEncoder_R101(nn.Module):
    def __init__(self):
        super().__init__()
        #resnet = models.resnet50(pretrained=True)
        resnet = models.resnet101()
        state_dict=torch.load(r'/ghome/linfc/my_VOS_new/pretrained_resnet/resnet101-5d3b4d8f.pth')
        resnet.load_state_dict(state_dict)        
...
class KeyEncoder_RX50(nn.Module):
    def __init__(self):
        super().__init__()
        resnet = models.resnext50_32x4d()
        state_dict=torch.load(r'/ghome/linfc/my_VOS_new/pretrained_resnet/resnext50_32x4d-7cdf4587.pth')
        resnet.load_state_dict(state_dict)        
...
class KeyEncoder_RX101(nn.Module):
    def __init__(self):
        super().__init__()
        resnet = models.resnext101_32x8d()
        state_dict=torch.load(r'/ghome/linfc/my_VOS_new/pretrained_resnet/resnext101_32x8d-8ba56ff5.pth')
        resnet.load_state_dict(state_dict)        
