...
class GloRe_Unit(nn.Module):
    ...
    """
    def __init__(self, num_in, num_mid, num_node, 
                 ConvNd=nn.Conv3d,
...
class GloRe_Unit_1D(GloRe_Unit):
    def __init__(self, num_in, num_mid, num_node, normalize=False):
        """
        Set 'normalize = True' if the input size is not fixed
        """
        super(GloRe_Unit_1D, self).__init__(num_in, num_mid, num_node,
                                            ConvNd=nn.Conv1d,
...
class GloRe_Unit_2D(GloRe_Unit):
    def __init__(self, num_in, num_mid, num_node, normalize=False):
        ...
        Set 'normalize = True' if the input size is not fixed
        """
        super(GloRe_Unit_2D, self).__init__(num_in, num_mid, num_node,
                                            ConvNd=nn.Conv2d,
...
class GloRe_Unit_3D(GloRe_Unit):
    def __init__(self, num_in, num_mid, num_node, normalize=False):
        ...
        Set 'normalize = True' if the input size is not fixed
        """
        super(GloRe_Unit_3D, self).__init__(num_in, num_mid, num_node,
                                            ConvNd=nn.Conv3d, 
                                            BatchNormNd=nn.BatchNorm3d,
                                            normalize=normalize)
